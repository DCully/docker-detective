...
import { IBreadcrumbItem } from "react-d3-treemap/dist/components/Breadcrumb";
...
const FileSystemTreeMap: React.FC<FileSystemTreeMapProps> = (props: FileSystemTreeMapProps) => {
    ...
    function zoomies(zoomLevel: number, zoomId: number, breadcrumbItems: IBreadcrumbItem[]) {
        for (let breadcrumbItem of breadcrumbItems) {
            console.log(breadcrumbItem.text)
        }
        //setState({})
    }
