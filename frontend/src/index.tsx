...
const LayerFileSystemTreeMapsInDrawers: React.FC<LayerFsTreemapsProps> = (props: LayerFsTreemapsProps) => {

    const accordionItems: any[] = []
    for(let i = 0; i < props.layers.length; i++) {
        accordionItems.push(
            <AccordionItem key={i} eventKey={i.toString()}>
                <Accordion.Header>{props.layers[i][0]}</Accordion.Header>
                <Accordion.Body>
                    <FileSystemTreeMap data={props.layers[i][1]}></FileSystemTreeMap>
                </Accordion.Body>
            </AccordionItem>
        )
    }
...
const App: React.FC = () => {
    return <div>
        <h1>{imageName}</h1>
        <Tabs>
            <Tab eventKey="image" title="Image File System">
                <FileSystemTreeMap data={d}></FileSystemTreeMap>
            </Tab>
            <Tab eventKey="layers" title="Image Layers">
                <LayerFileSystemTreeMapsInDrawers layers={l}></LayerFileSystemTreeMapsInDrawers>
            </Tab>
        </Tabs>
    </div>
}
